...
export default function ProductsPage() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-600">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#E60012] to-[#FF5E62] py-24 lg:py-32 overflow-hidden text-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* BIP */}
              <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="relative z-10">
                   <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-red-100/50 rounded-xl flex items-center justify-center text-[#E60012]">
                        <Globe className="w-6 h-6" />
                      </div>
                      <div>
                        <h3 className="text-2xl font-black text-[#1F2329]">用友 BIP 商业创新平台</h3>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="relative z-10">
                   <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-blue-100/50 rounded-xl flex items-center justify-center text-[#0052D9]">
                        <Zap className="w-6 h-6" />
                      </div>
                      <div>
                        <h3 className="text-2xl font-black text-[#1F2329]">YonSuite 成长型商业创新平台</h3>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border-t-4 border-orange-500 relative overflow-hidden">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                   <div className="flex items-start gap-4 md:w-1/3">
                      <div className="w-12 h-12 bg-orange-100/50 rounded-xl flex items-center justify-center text-orange-600 shrink-0">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  { icon: Activity, name: 'AI 智能平台', desc: 'YonGPT大模型驱动的企业大脑', color: 'text-emerald-600', bg: 'bg-emerald-50' },
                   ...
                   <div key={item.name} className="bg-slate-800 rounded-2xl p-6 text-slate-300 flex items-center gap-4 hover:bg-slate-700 transition-colors">
                   ...
                   <div key={category.name} className="space-y-6">
                      ...
                      <div className="grid gap-4">
                         {category.items.map((item) => {
                            ...
                            return (
                               <Link key={item.href} href={item.href} className="group flex items-start gap-4 p-4 rounded-xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
      ...
      <section className="py-24 bg-[#1F2329] text-white text-center">
         <div className="container mx-auto px-4 max-w-3xl">
            <h2 className="text-3xl font-bold mb-6">不确定哪个产品适合您？</h2>
            <p className="text-slate-400 mb-10 text-lg">我们的专家顾问可以为您提供免费的业务诊断和产品选型建议。</p>
            <div className="flex justify-center gap-4">
               <Link href="/contact" className="px-8 py-4 bg-[#E60012] text-white font-bold rounded-xl hover:bg-red-600 transition-colors">
                  预约专家咨询
               </Link>
               <Link href="/pricing" className="px-8 py-4 bg-white/10 text-white font-bold rounded-xl hover:bg-white/20 transition-colors border border-white/20">
                  查看价格体系
               </Link>
            </div>
         </div>
