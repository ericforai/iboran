...
export const FAQ = () => {
  ...
  const faqs = [
    ...
    {
      q: '支持哪些财务 ERP 系统的集成？',
      a: '提供用友（YonBIP/NC/U8/Cloud）、SAP、Oracle、金碟（云星空/K3）等主流 ERP 的标准插件或 Open API，以保障凭证自动生成与基础资料实时同步。',
    },
    {
      q: '银企直联是否安全？',
    ...
    {
      q: '如何处理员工旧有的垫款历史数据？',
      a: '我们提供标准数据导入模板，可一键挂载历史欠款，以保障系统启用后的账务衔接。系统上线初期可设置“双轨运行期”以供平滑过渡。',
    },
    {
      q: '系统的收费模式是怎样的？',
