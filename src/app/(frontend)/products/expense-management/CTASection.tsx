      ...
      <div className="container px-4 mx-auto relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-8 leading-tight font-heading">
            准备好开启 <br />
            <span className="text-blue-400">财务管理的数字化新篇章？</span>
          </h2>
          <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            立即申请专家演示，我们将根据您的企业现状，为您定制专属的业财一体化费控方案。
          </p>
          ...
          <div className="mt-16 pt-16 border-t border-white/10 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="text-xs text-slate-500 uppercase tracking-widest font-bold">成功案例</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white mb-2 font-heading">1400+</div>
              <div className="text-xs text-slate-500 uppercase tracking-widest font-bold">对接银行</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white mb-2 font-heading">24H</div>
              <div className="text-xs text-slate-500 uppercase tracking-widest font-bold">应急响应</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white mb-2 font-heading">99%以上</div>
              <div className="text-xs text-slate-500 uppercase tracking-widest font-bold">合规保证</div>
            </div>
          </div>
        </div>
      </div>
