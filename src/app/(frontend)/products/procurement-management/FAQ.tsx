...
export const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: '是的。致远数字化采购平台内置了多种标准适配器，支持与用友 BIP、U9、U8 系列，以及 SAP、Oracle 等主流 ERP 进行深度数据联动，包含基础物料同步、订单同步、到货通知、收票对账等业务。'
    },
    {
      q: '供应商使用该平台是否需要付费？',
    ...
    },
    {
      ...
      a: '基于 COP 平台的流程灵活性，我们可以预置“绿色通道”或“先办后补”流程，支持手机端随时随地审批，确保业务连续性。对于非标物资，可以通过“附件寻源”功能实现图纸、技术规格书的精准协同。'
    },
    {
      q: '系统支持私有化部署还是云端部署？',
      a: '系统支持多种模式：本地机房部署（私有化）、云主机部署（阿里云/华为云等）以及致远官方 SaaS 服务模型，满足不同企业在数据自主性与维护便捷性上的平衡。'
    }
  ]
