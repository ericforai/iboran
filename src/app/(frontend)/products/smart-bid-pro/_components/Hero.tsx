...
export const Hero = () => {
  return (
    <section id="hero" className="relative min-h-[85vh] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden bg-white">
      ...
      <div className="container relative z-10 px-6 max-w-7xl mx-auto text-center font-sans">
        ...
        <motion.p
          ...
          className="max-w-4xl mx-auto text-lg md:text-xl text-slate-600 mb-12 leading-relaxed font-medium"
        >
        ...
        >
          <Link 
            href="/contact"
            className="h-14 px-10 rounded-full bg-blue-600 text-white font-bold text-lg hover:bg-blue-700 transition-all shadow-xl shadow-blue-600/20 flex items-center gap-2 group"
          >
            预约产品演示
            <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <button className="h-14 px-10 rounded-full border border-slate-200 bg-white text-slate-700 font-bold text-lg hover:bg-slate-50 hover:border-slate-300 transition-all flex items-center gap-2 shadow-sm">
            <Download size={20} />
            立即下载产品简介
          </button>
        </motion.div>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-8 py-10 px-8 bg-slate-50/80 border border-slate-100 rounded-3xl backdrop-blur-sm max-w-5xl mx-auto shadow-sm"
        >
