...
export default function FAQ() {
  const faqs = [
    ...
    {
      q: "支持私有化部署吗？数据安全怎么保障？",
      a: "支持。BIP 提供公有云、专属云、私有云 (On-Premise) 等多种部署模式。对于对数据主权有严格要求的国央企，我们推荐私有云部署方案，充分适配国产化软硬件环境。"
    },
    {
      q: "旧系统的数据能迁移过来吗？",
      a: "可以。我们提供标准的数据迁移工具和实施方法论。在“咨询诊断”阶段，我们会评估历史数据的质量，制定清洗和迁移方案，以保障新旧系统平滑过渡。"
    },
    {
      q: "费用是如何构成的？",
