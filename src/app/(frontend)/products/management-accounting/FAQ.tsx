...
const faqs = [
  {
    ...
    answer: '通过事项会计中台，对每一笔业务事项进行独立捕获。财务会计基于法定会计准则进行外报处理，管理会计则基于管理口径的成本中心、要素和规则进行内部核算。两者在事项层实现同源分流，互不干扰，确保外报合规的同时支撑内部精准决策。'
  },
  {
    question: '支持多币种和跨国企业的核算吗？',
    answer: '完全支持。系统具备全领域拉通的多币种（组织币、账簿币、集团币、全局币）折算和同步核算能力，满足全球布局企业在不同国家、不同币种环境下的数据报告与合并诉求。'
  },
  {
    question: '实施周期大概需要多久？',
