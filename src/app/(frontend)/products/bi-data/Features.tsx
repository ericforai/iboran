...
const features = [
  ...
  },
  {
    ...
    icon: Calculator,
    title: '专为财务与经营分析打造',
    description: '内置GLAMT、GLOPENBAL等12种专业财务业务函数，轻松应对复杂的财务报表需求。支持层级坐标公式与累计计算，完美解决同比、环比及跨期分析难题。',
    points: [
  ...
  },
  {
    ...
    icon: Smartphone,
    title: '随时随地，数据触手可及',
    description: '完美适配移动端浏览体验，支持与企业微信、钉钉及YonBuilder应用无缝集成。分析卡片可直接嵌入业务流程，让数据在业务场景中发挥实时价值。',
    points: [
      '移动端自适应布局，一次设计多端发布',
      '支持分析卡片嵌入移动门户与业务单据',
