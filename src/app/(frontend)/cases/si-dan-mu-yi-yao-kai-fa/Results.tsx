        ...
        <div className="grid md:grid-cols-3 gap-8">
          {results.map((result, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Icon className="w-8 h-8 text-cyan-400" />
                </div>
                <div className="text-5xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors duration-300">
                  {result.value}
                </div>
