      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">医药与医疗健康行业正处于高合规要求与数字化转型的交汇点。从研发创新、合规生产到精准流通，企业亟需构建一套符合 GXP 标准的一体化管理体系。泊冉软件通过数智化平台，以保障企业在严苛监管下实现效率与安全的双重跨越。 项目背景：宣泰药业提供医药产品研发、生产和销售服务，专注于仿制药、原料药及制剂产品。</p>
          </div>
        </div>
      </div>
    </section>
