...
export default function CTA() {
  return (
    <section className="py-24 bg-gradient-to-br from-orange-500 to-amber-600 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-teal-400/10 rounded-full blur-[100px]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <p className="text-xl text-orange-100 mb-10 max-w-2xl mx-auto">
            了解泊冉软件如何帮助您的宠物经济企业实现数字化转型，获取专属解决方案与报价。
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="group inline-flex items-center gap-3 px-8 py-4 bg-white text-orange-600 rounded-full font-bold text-lg hover:bg-orange-50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            >
              <span>预约专家演示</span>
          ...
          {/* Trust indicators */}
          <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-orange-100 text-sm">
