    ...
    <section className="py-24 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white relative overflow-hidden" id="results">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/20 backdrop-blur-sm rounded-full mb-6 border border-green-500/30">
            <TrendingUp className="w-4 h-4 text-green-400" />
            <span className="text-sm font-semibold text-green-400">项目价值</span>
          </div>
        ...
        {/* Bottom Summary */}
        <div className="mt-16 p-8 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl border border-white/10 text-center">
          <p className="text-lg text-slate-300">
            通过数字化转型，原能生物实现了<span className="text-white font-semibold"> 业财一体化</span>、
