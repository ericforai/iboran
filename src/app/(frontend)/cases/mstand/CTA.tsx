...
export default function CTA() {
  return (
    <section className="py-24 bg-gradient-to-br from-[#0A0F1C] via-slate-900 to-[#0A0F1C] relative overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 3px 3px, rgba(212, 175, 55, 0.3) 1px, transparent 0)`,
      ...
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-amber-700/5 rounded-full blur-[100px]" />
