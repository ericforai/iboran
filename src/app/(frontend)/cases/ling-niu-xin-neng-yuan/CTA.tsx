...
export default function CTA() {
  return (
    <section className="py-24 bg-gradient-to-br from-emerald-600 via-green-700 to-teal-700 relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <p className="text-xl text-emerald-100 mb-10 max-w-2xl mx-auto">
            了解泊冉软件如何帮助您的新能源企业实现数字化转型，获取专属解决方案与报价。
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="group inline-flex items-center gap-3 px-8 py-4 bg-white text-emerald-700 rounded-full font-bold text-lg hover:bg-emerald-50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            >
              <span>预约专家演示</span>
