...
export default function Results() {
  return (
    <section className="py-24 bg-gradient-to-br from-slate-900 via-[#0A1F3C] to-slate-900 text-white relative overflow-hidden">
      {/* Background pattern */}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {results.map((result, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-500/20 to-orange-500/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Icon className="w-8 h-8 text-amber-400" />
                </div>
                <div className="text-5xl font-bold text-white mb-3 group-hover:text-amber-400 transition-colors duration-300">
                  {result.value}
                </div>
