...
export default function CTA() {
  return (
    <section className="py-24 bg-gradient-to-br from-purple-600 via-indigo-700 to-purple-700 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10">
        ...
        <div className="text-center text-white">
          ...
          <p className="text-xl text-purple-100 mb-12 max-w-2xl mx-auto leading-relaxed">
            泊冉软件拥有 12+ 年企业数字化服务经验，已助力 500+ 家文创企业实现精细化转型
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-10 py-5 bg-white text-purple-700 rounded-full font-bold text-lg hover:bg-purple-50 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1"
            >
              立即咨询
        ...
        <div className="mt-16 grid grid-cols-3 gap-8 text-center text-white">
          <div>
            ...
            <div className="text-sm text-purple-200">年服务经验</div>
          </div>
          <div>
            <div className="text-3xl font-bold mb-1">500+</div>
            <div className="text-sm text-purple-200">家服务企业</div>
          </div>
          <div>
            <div className="text-3xl font-bold mb-1">98%</div>
            <div className="text-sm text-purple-200">交付成功率</div>
          </div>
        </div>
      </div>
    </section>
