...
const challenges = [
  ...
  },
  {
    icon: Calculator,
    title: "成本管控不精细",
    desc: "缺乏工序级、材料级的实时成本采集，导致单笔订单毛利分析滞后，难以支持精准的价格决策。"
  },
  {
    icon: ShieldCheck,
    title: "质量管理断层",
    desc: "质量数据散落在纸质单据或离散系统中，无法实现从原材料采购到成品出库的全链路追溯。"
  }
]
    ...
    <section className="py-24 bg-slate-50">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto">阻碍增长效率的瓶颈与痛点</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {challenges.map((challenge, index) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
