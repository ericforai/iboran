...
const solutions = [
  {
    icon: Database,
    title: "一站式业财一体化",
    desc: "构建统一的数据中台，集成 ERP、MES、SRM 及财务模块，实现业务单据自动转化为财务凭证，以保障账实相符。",
    features: ['ERP 集成', '财务自动凭证', '账实相符']
  },
  {
    icon: Link2,
    title: "供应链协同可视化",
    desc: "建立供应商门户与交期监控看板，实现订单、发货、对账的全流程在线化，提升外部响应效率。",
          ...
          {solutions.map((solution, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-6 flex items-center gap-2 text-orange-500 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span>了解更多</span>
