        ...
        <div className="grid lg:grid-cols-12 gap-12">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-900">正帆科技</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-900">制造 / 专用设备</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center shrink-0">
          ...
          <div className="lg:col-span-8">
            <div className="mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">高纯工艺系统数字化升级</h2>
              <p className="text-lg text-slate-600 leading-relaxed mb-6">
                正帆科技提供高纯工艺系统、气体化学品供应系统、洁净室工程及配套设备，服务于半导体、生物医药、新能源等高科技产业。在全球化竞争与供应链波动常态化的背景下，企业需要从&quot;规模驱动&quot;向&quot;效率与创新驱动&quot;转型。
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-5 bg-slate-50 rounded-xl border border-slate-200">
                <div className="text-2xl font-bold text-[#0052D9] mb-1">半导体</div>
                <p className="text-sm text-slate-600">高纯工艺系统与气体化学品供应</p>
              </div>
              <div className="p-5 bg-slate-50 rounded-xl border border-slate-200">
                <div className="text-2xl font-bold text-cyan-500 mb-1">生物医药</div>
                <p className="text-sm text-slate-600">洁净室工程及配套设备</p>
              </div>
            </div>
          </div>
        </div>
