        ...
        <div className="grid md:grid-cols-3 gap-8">
          {results.map((result, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#0052D9]/20 to-cyan-500/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
