      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            了解泊冉软件如何帮助您的IT服务企业实现数字化转型，获取专属解决方案与报价。
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="group inline-flex items-center gap-3 px-8 py-4 bg-white text-blue-600 rounded-full font-bold text-lg hover:bg-blue-50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            >
              <span>预约专家演示</span>
