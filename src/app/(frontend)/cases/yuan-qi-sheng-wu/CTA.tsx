...
export default function CTA() {
  return (
    <section className="py-24 bg-gradient-to-br from-purple-700 to-blue-700 relative overflow-hidden">
      {/* Decorative Circles */}
      ...
      <div className="container mx-auto px-4 relative z-10 text-center text-white">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            准备好加速您的<br/>创新药研发进程了吗？
          </h2>
          <p className="text-purple-100 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
            立即预约专家顾问，探索符合 GXP 标准的生物医药研发数字化解决方案。
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              href="/contact" 
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-purple-600 hover:bg-purple-50 rounded-full font-bold text-lg transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
            >
              立即咨询专家
