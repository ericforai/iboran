...
// Transportation/Transit themed SVG illustration
function TransportationTransitSVG() {
  return (
    <svg viewBox="0 0 500 400" className="w-full h-auto" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="blueGradTransit" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#3b82f6" />
          <stop offset="100%" stopColor="#2563eb" />
        </linearGradient>
        <linearGradient id="cyanGradTransit" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Central Hub - Digital Transportation Platform */}
      <g transform="translate(250, 200)">
        {/* Platform Base */}
        <rect x="-70" y="-70" width="140" height="140" rx="16" fill="url(#blueGradTransit)" opacity="0.9">
        ...
        {/* Data Grid */}
        <g fill="url(#cyanGradTransit)" opacity="0.6">
        ...
        {/* Center Icon - Transport Hub */}
        <circle cx="0" cy="0" r="18" fill="url(#blueGradTransit)">
          <animate attributeName="r" values="18;21;18" dur="2s" repeatCount="indefinite" />
        </circle>
        {/* Bus/Transport Symbol */}
        <g fill="white">
          <rect x="-8" y="-5" width="16" height="10" rx="2" opacity="0.9" />
          <circle cx="-4" cy="6" r="2.5" opacity="0.9" />
          <circle cx="4" cy="6" r="2.5" opacity="0.9" />
        </g>
      </g>
      ...
      <g transform="translate(60, 80)">
        ...
        <text x="55" y="42" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="8">多系统集成</text>
        {/* Document Icon */}
        <rect x="8" y="8" width="10" height="14" fill="#3b82f6" opacity="0.8" rx="1" />
      </g>

      {/* Top Right - Treasury Management */}
      <g transform="translate(330, 80)">
        ...
        <text x="55" y="42" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="8">资金集中管控</text>
        {/* Vault Icon */}
        <rect x="8" y="10" width="14" height="12" fill="#06b6d4" opacity="0.8" rx="1" />
        <circle cx="15" cy="16" r="2" fill="#0a1628" opacity="0.5" />
      </g>

      {/* Bottom Left - Tax & Contract */}
      <g transform="translate(60, 255)">
        <rect x="0" y="0" width="110" height="65" rx="8" fill="rgba(59, 130, 246, 0.15)" stroke="rgba(59, 130, 246, 0.3)" strokeWidth="1.5">
          <animate attributeName="y" values="255;260;255" dur="3s" begin="0.6s" repeatCount="indefinite" />
        </rect>
        <text x="55" y="25" textAnchor="middle" fill="white" fontSize="10" fontWeight="600">税务与合同</text>
        <text x="55" y="42" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="8">线上化标准化</text>
        {/* Contract Icon */}
        <rect x="8" y="10" width="12" height="14" fill="#3b82f6" opacity="0.8" rx="1" />
        <line x1="10" y1="14" x2="18" y2="14" stroke="#0a1628" strokeWidth="1" opacity="0.5" />
        <line x1="10" y1="17" x2="16" y2="17" stroke="#0a1628" strokeWidth="1" opacity="0.5" />
      </g>

      {/* Bottom Right - Financial Shared Services */}
      <g transform="translate(330, 255)">
        <rect x="0" y="0" width="110" height="65" rx="8" fill="rgba(6, 182, 212, 0.15)" stroke="rgba(6, 182, 212, 0.3)" strokeWidth="1.5">
          <animate attributeName="y" values="255;260;255" dur="3s" begin="0.9s" repeatCount="indefinite" />
        </rect>
        <text x="55" y="25" textAnchor="middle" fill="white" fontSize="10" fontWeight="600">财务共享</text>
        <text x="55" y="42" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="8">业财融合</text>
        {/* Shared Service Icon */}
        <circle cx="15" cy="16" r="5" fill="none" stroke="#06b6d4" strokeWidth="1.5" opacity="0.8" />
        <circle cx="11" cy="14" r="2" fill="#06b6d4" opacity="0.6" />
        <circle cx="19" cy="14" r="2" fill="#06b6d4" opacity="0.6" />
        <circle cx="15" cy="20" r="2" fill="#06b6d4" opacity="0.6" />
      </g>

      {/* Transportation Elements - Buses */}
      {/* Bus 1 - Left */}
      <g transform="translate(80, 180)">
        <rect x="0" y="0" width="45" height="20" rx="4" fill="url(#blueGradTransit)" opacity="0.7">
          <animate attributeName="x" values="80;85;80" dur="4s" repeatCount="indefinite" />
        </rect>
        <rect x="5" y="4" width="8" height="6" fill="rgba(255,255,255,0.5)" rx="1" />
        <rect x="15" y="4" width="8" height="6" fill="rgba(255,255,255,0.5)" rx="1" />
        <rect x="25" y="4" width="8" height="6" fill="rgba(255,255,255,0.5)" rx="1" />
        <circle cx="10" cy="17" r="3" fill="#1a365d" />
        <circle cx="35" cy="17" r="3" fill="#1a365d" />
      </g>

      {/* Bus 2 - Right */}
      <g transform="translate(375, 200)">
        <rect x="0" y="0" width="45" height="20" rx="4" fill="url(#cyanGradTransit)" opacity="0.7">
      ...
      {/* Bottom Road/Track Element */}
      <g opacity="0.3">
        <rect x="180" y="375" width="140" height="3" rx="1.5" fill="url(#blueGradTransit)">
