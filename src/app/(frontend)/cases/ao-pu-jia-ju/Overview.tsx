        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4 p-8 bg-slate-50 rounded-2xl">
            ...
            <div className="space-y-4 text-sm text-slate-600">
              <p><span className="font-semibold text-slate-900">客户：</span>奥普家居</p>
              <p><span className="font-semibold text-slate-900">行业：</span>消费品 / 家居</p>
              <p><span className="font-semibold text-slate-900">方案：</span>系统化解决方案部署。</p>
            </div>
          </div>
          <div className="lg:col-span-8">
            <h2 className="text-3xl font-bold mb-8">项目背景</h2>
            <p className="text-lg text-slate-600 leading-relaxed">提供家居产品，主要包括集成吊顶、浴霸、照明电器及智能家居系统。</p>
          </div>
        </div>
      </div>
    </section>
