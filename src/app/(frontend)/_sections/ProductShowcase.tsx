...
export const ProductShowcase: React.FC = React.memo(() => {
  return (
    <section className="min-h-screen lg:h-screen flex items-center py-16 lg:py-12 bg-white relative overflow-hidden isolate">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl lg:text-7xl font-bold text-slate-900 tracking-tighter leading-[1] sm:leading-[0.95] lg:leading-[0.9] mb-6">
            全场景业财融合 
        ...
        <motion.div 
           ...
           variants={staggerVariants}
           className="grid grid-cols-1 lg:grid-cols-12 gap-5 h-auto lg:min-h-[500px]"
        >
          {/* LEFT COLUMN: ERP CORE */}
          <motion.div variants={fadeInUp} className="lg:col-span-5 relative group">
             <NeuCard variant="dark" className="h-full p-8 flex flex-col justify-between relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-3xl font-bold text-white mb-2 tracking-tight">ERP 与业务系统</h3>
            ...
            <NeuCard variant="raised" className="flex-1 p-6 relative overflow-hidden bg-slate-50 border-white/60 hover:bg-white transition-colors">
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                     <h3 className="text-xl font-bold text-slate-900 leading-none">协同与流程平台</h3>
            ...
            <NeuCard variant="inset" className="flex-1 p-6 relative overflow-hidden bg-emerald-50/30 border-emerald-100/50">
               <div className="relative z-10 flex flex-col h-full">
                 <div className="flex items-center gap-3 mb-4">
                   ...
                   <div>
                      <h3 className="text-xl font-bold text-slate-900 leading-none">数据与开发集成平台</h3>
