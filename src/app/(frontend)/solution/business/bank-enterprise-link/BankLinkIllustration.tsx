  ...
  return (
    <div className="w-full h-full min-h-[500px] flex items-center justify-center relative">
      ...
      >
        ...
        {/* 银行连接节点与数据流 */}
        {[
          { x: 150, y: 300, label: "ICBC 工商银行", color: "#E60012" }, // Left
          { x: 850, y: 300, label: "CMB 招商银行", color: "#E60012" }, // Right
          { x: 500, y: 650, label: "BOC 中国银行", color: "#E60012" }, // Bottom
          { x: 500, y: 50, label: "Citi 花旗", color: "#0052D9" }      // Top
        ].map((node, i) => (
          <g key={i}>
             {/* 连接线 */}
             <path 
                d={`M${node.x} ${node.y} L${i === 0 ? 330 : i === 1 ? 670 : i === 2 ? 500 : 500} ${i === 2 ? 500 : i === 3 ? 150 : 350}`} 
                stroke={node.color} 
                strokeOpacity="0.15" 
                strokeWidth="2" 
                strokeDasharray="4 4" 
             ...
             <circle r="4" fill={node.color}>
                <animateMotion 
                    ...
                    path={`M${node.x} ${node.y} L${i === 0 ? 330 : i === 1 ? 670 : i === 2 ? 500 : 500} ${i === 2 ? 500 : i === 3 ? 150 : 350}`}
                />
             </circle>
        ...
        <g transform="translate(580, 420)">
           <path d="M0 0 L12 12 L7 13 L5 19 L0 0 Z" fill="#000000" stroke="white" strokeWidth="1">
