...
const tabs = [
  {
    ...
    metrics: ['盘点效率提升 90%', '账实一致率 99%以上'],
    features: ['RFID/二维码快速入库', '多维度分类体系', '资产全路径轨迹树']
  },
  {
    id: 'maintenance',
    title: '智能运行维护',
    desc: '从“坏了才修”到“预防为主”。基于工况与运行时间自动触发多级维保计划，闭环工单体系以保障维护作业标准化，显著延长资产使用寿命。',
    icon: <Wrench size={22} />,
  ...
  },
  {
    id: 'inspection',
    title: '移动巡检与安全',
    desc: '消除现场管理盲区。移动化巡检工具结合标准化检查清单，实现异常实时捕捉与即时通报，以保障特种设备与关键节点的运行合规与安全。',
    icon: <Cpu size={22} />,
    metrics: ['安全事故减少 15%', '巡检质量 99%以上 留痕'],
