...
const features = [
  ...
  },
  {
    icon: Smartphone,
    title: '工序级实时报工',
    desc: '多端（PDA/工控机）实时报工。数据无需二次录入，直接驱动成本卷积计算，以保障"料动账动"。'
  },
  {
    icon: BarChartHorizontal,
    title: 'Andon 异常安灯',
    desc: '车间异常一键呼叫，声光报警联动。多级推送机制以保障设备故障、缺料等问题得到快速响应与处理。'
  },
  {
    icon: Link,
    title: '线边仓与投料防错',
    desc: '生产现场线边库存实时扣减，与 AGV 联动实现自动叫料。关键工序扫码投料防错，以保障物料准确无误。'
  }
]
