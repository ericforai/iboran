        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button onClick={handleOpenConsult} className="px-8 py-4 bg-transparent border-2 border-white/30 text-white font-bold rounded-lg hover:bg-white/10 transition-all">
                在线咨询顾问
              </button>
            </div>
          </motion.div>
