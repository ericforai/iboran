...
const featureTabs = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: '继任计划管理', desc: '自动发现关键岗位缺口，建立人才池，以保障核心岗位不间断供应。' }
    ],
  ...
  },
  {
    ...
    features: [
      { title: '战略目标分解', desc: '上下同欲，将公司大目标层层分解至个人，以保障员工努力方向一致。' },
      { title: '即时反馈沟通', desc: '打破年终「一考定终身」，通过持续反馈提升员工绩效，管理效率提升 40%。' },
      { title: '绩效分析洞察', desc: '智能分析团队与个人能力短板，自动生成针对性改进建议。' },
      { title: '多维评价体系', desc: '上级、同事、下属、客户全方位评估，以保障评价结果客观公平。' }
    ],
  ...
  },
  {
    ...
    features: [
      { title: '标准化作业平台', desc: '全级次任务分流与协作，以保障全国乃至全球服务标准高度统一。' },
      { title: '数智员工 (RPA)', desc: '自动处理社保申报、流程预警、证明开具等重复工作，零差错率。' },
      { title: '智能客服助理', desc: '7×24 小时在线，通过语音或文字解答政策问询，自助服务覆盖率 99%以上。' },
