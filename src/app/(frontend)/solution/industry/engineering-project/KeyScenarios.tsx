...
const scenarios = [
  {
    ...
    solution: '建立统一的项目库，实现项目编码、名称标准化。数字化招投标平台确保过程全留痕，从制度驱动走向数据驱动。',
    outcome: '消除重复立项，招投标效率提升30%以上，确保项目从源头即满足企业内控合规要求。',
  },
  {
    title: '合同与业财深度融合',
    icon: HandCoins,
  ...
  },
  {
    ...
    outcome: '重大隐患整改闭环率达到100%，质量缺陷可一键追根溯源，管理颗粒度深入至各分包单位。',
  },
  {
    title: '结算与资产价值闭环',
    icon: FileCheck,
    ...
    outcome: '竣工结算周期缩短40%，转固准确率提升至100%，确保企业资产账实相符。',
  },
]
