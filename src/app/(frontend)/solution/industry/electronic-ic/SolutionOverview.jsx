...
exports.default = SolutionOverview;
...
var description = '泊冉软件基于用友BIP超级版，为电子IC行业构建"研供产销服"一体化平台。针对Fabless模式，重点强化委外协同与批号追踪；针对IDM模式，强化生产执行与良率分析，帮助企业实现从实验室研发到规模化量产的全过程数智化。';
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {coreProducts.map(function (product, idx) { return (<div key={idx} className="flex items-start gap-3 p-4 bg-white rounded-lg shadow-sm">
                  <lucide_react_1.CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5"/>
                  <div>
