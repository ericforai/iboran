        ...
        <div className="bg-slate-900 rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-slate-400 text-lg mb-10">
              预约专家演示，获取量身定制的 TES 智能差旅与费控解决方案，助力企业降本增效，实现合规管控。
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="px-12 py-5 border border-slate-700 text-white font-semibold rounded-lg hover:bg-slate-800 transition-all">
                在线咨询方案详情
              </button>
            </div>
          </div>
