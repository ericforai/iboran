      ...
      <div className="container mx-auto px-4">
        <div className="bg-gradient-to-r from-[#0052D9] to-[#003A9B] rounded-3xl p-12 lg:p-20 text-center relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
            ...
            <button onClick={handleOpenConsult} className="px-10 py-4 border-2 border-white/30 text-white font-bold rounded-lg hover:bg-white/10 transition-all w-full sm:w-auto">
              下载产品折页
            </button>
          </div>
        </div>
