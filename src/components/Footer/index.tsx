...
export const Footer = () => {
    return (
      <footer className="relative bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800 pt-12 md:pt-24 pb-10 md:pb-20">
        ...
        <div className="container mx-auto px-5 md:px-6 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-12 gap-6 md:gap-8 gap-y-8 md:gap-y-12 lg:gap-8 mb-9 md:mb-20">
            {/* Brand Column */}
            <div className="col-span-2 md:col-span-1 lg:col-span-6 space-y-5 md:space-y-8 lg:order-1">
              <div className="space-y-3 md:space-y-4">
                ...
                <p className="hidden md:block text-sm leading-relaxed max-w-sm text-slate-500 dark:text-slate-400">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start gap-3 md:gap-4 group">
                  <div className="w-7 h-7 md:w-8 md:h-8 rounded-lg bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center shrink-0 mt-0.5 transition-colors group-hover:bg-blue-100 dark:group-hover:bg-blue-900/30">
                ...
                <div className="flex items-center gap-3 md:gap-4 group">
                  <div className="w-7 h-7 md:w-8 md:h-8 rounded-lg bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center shrink-0 transition-colors group-hover:bg-blue-100 dark:group-hover:bg-blue-900/30">
                    <Phone className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                  </div>
                  <span className="text-2xl md:text-lg font-mono font-bold text-slate-900 dark:text-white tracking-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    400-9955-161
                  </span>
                </div>
              </div>
              ...
              <div className="md:hidden">
                <div className="grid grid-cols-3 gap-2">
                  <Link href="/products" className="text-center text-xs font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg py-2.5">产品中心</Link>
                  <Link href="/cases" className="text-center text-xs font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg py-2.5">客户案例</Link>
                  <Link href="/contact" className="text-center text-xs font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg py-2.5">联系我们</Link>
                </div>
              </div>
            </div>
  
            {/* Links Columns Group (Mobile Col 1) */}
            <div className="col-span-1 hidden md:flex md:flex-col gap-6 md:gap-10 md:contents">
              <div className="lg:col-span-2 md:col-span-1 lg:order-2 hidden md:block">
                <h4 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider mb-4 md:mb-6">产品中心</h4>
              ...
              <div className="lg:col-span-2 md:col-span-1 lg:order-4 hidden md:block">
                <h4 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider mb-4 md:mb-6">关于我们</h4>
                <ul className="space-y-2.5 md:space-y-3 text-sm">
            ...
            <div className="lg:col-span-2 md:col-span-1 lg:order-3 hidden md:block">
              <h4 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider mb-4 md:mb-6">核心领域</h4>
              <ul className="space-y-2.5 md:space-y-3 text-sm">
          ...
          {/* Bottom Bar */}
          <div className="pt-5 md:pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
            ...
            <div className="flex gap-3 md:gap-4 text-xs text-slate-500 dark:text-slate-500 lg:pr-64">
